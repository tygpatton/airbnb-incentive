...
if __name__ == '__main__':
	df = pd.read_csv('parsed/cleaned_full2.csv')
	
	with open('models/kdtree_full2.pkl') as f:
		kdtree = pickle.load(f)

	featurized = compute_comps_median(df, kdtree)

	featurized = add_city_median(featurized)

	featurized.to_csv('parsed/featurized_full_4.csv')